...
import { MapPin, CheckCircle, Plus, Shield, ChevronRight } from 'lucide-react';
  ...
  return (
    <div className="p-6 md:p-12 max-w-7xl mx-auto space-y-12 bg-[#FDFDFD] min-h-screen text-gray-900 font-sans relative overflow-x-hidden">
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-start md:items-end justify-between gap-6">
        ...
        >
          <div className="absolute inset-0 bg-linear-to-br from-brand-50/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
        ...
        <section className="lg:col-span-8 space-y-8">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <motion.div
              ...
              onClick={() => navigate('/contribute/add-stop')}
            >
            ...
            <motion.div
              whileHover={{ y: -4 }}
              className="bg-white p-8 rounded-[2.5rem] border border-gray-100 shadow-sm cursor-pointer group relative overflow-hidden hover:shadow-xl hover:shadow-brand-900/5 transition-all"
              onClick={() => navigate('/contribute/validate')}
            >
            ...
            <motion.div
              ...
              onClick={() => navigate('/contribute/landmark')}
            >
