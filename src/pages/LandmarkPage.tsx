      ...
      <div className="max-w-2xl mx-auto space-y-8">
        <header className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-3xl font-black text-gray-900 tracking-tight">Landmarks</h1>
          </div>
        </header>
        ...
        <div className="bg-brand-50 border border-brand-100 p-8 rounded-[2rem] text-center">
          ...
          <h2 className="text-2xl font-black text-gray-900 mb-2">Visual Navigation</h2>
          <p className="text-gray-600 font-medium">
            Add or edit visual landmark hints for bus stops.
          </p>
        </div>
      </div>
    </div>
